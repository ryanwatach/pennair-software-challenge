  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xc1, 0x72, 0x51, 0x35, 0x72, 0x5c, 0xad, 0x17,
      0x4a, 0xfa, 0xe1, 0xa2, 0x3e, 0x44, 0x1b, 0xa5,
      0x9c, 0x98, 0x46, 0x12, 0xa0, 0xf3, 0x3c, 0x15,
      0xdd, 0x8b, 0x34, 0xf6, 0x1c, 0x36, 0xc2, 0x5f,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t pennair_vision_msgs__msg__Shape__EXPECTED_HASH = {1, {
...
static char pennair_vision_msgs__msg__ShapeArray__TYPE_NAME[] = "pennair_vision_msgs/msg/ShapeArray";
...
static char pennair_vision_msgs__msg__ShapeArray__FIELD_NAME__header[] = "header";
static char pennair_vision_msgs__msg__ShapeArray__FIELD_NAME__shapes[] = "shapes";
static char pennair_vision_msgs__msg__ShapeArray__FIELD_NAME__depth_inches[] = "depth_inches";
static char pennair_vision_msgs__msg__ShapeArray__FIELD_NAME__depth_valid[] = "depth_valid";

static rosidl_runtime_c__type_description__Field pennair_vision_msgs__msg__ShapeArray__FIELDS[] = {
  {
    {pennair_vision_msgs__msg__ShapeArray__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {pennair_vision_msgs__msg__ShapeArray__FIELD_NAME__shapes, 6, 6},
    {
  ...
  {
    {pennair_vision_msgs__msg__ShapeArray__FIELD_NAME__depth_inches, 12, 12},
    {
  ...
  {
    {pennair_vision_msgs__msg__ShapeArray__FIELD_NAME__depth_valid, 11, 11},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription pennair_vision_msgs__msg__ShapeArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {pennair_vision_msgs__msg__ShapeArray__TYPE_NAME, 34, 34},
      {pennair_vision_msgs__msg__ShapeArray__FIELDS, 4, 4},
    },
    {pennair_vision_msgs__msg__ShapeArray__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&pennair_vision_msgs__msg__Shape__EXPECTED_HASH, pennair_vision_msgs__msg__Shape__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[4].fields = pennair_vision_msgs__msg__Shape__get_type_description(NULL)->type_description.fields;
...
static char toplevel_type_raw_source[] =
  ...
  "std_msgs/Header header       # stamp/frame_id copied from the source image\n"
  "Shape[]          shapes\n"
  "float64          depth_inches  # scene depth used for the 3D centers\n"
  "bool             depth_valid   # false before the circle has ever been seen";
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *pennair_vision_msgs__msg__ShapeArray__get_individual_type_description_source(NULL),
    ...
    sources[5] = *pennair_vision_msgs__msg__Shape__get_individual_type_description_source(NULL);
